...
var getOpenCodeConfigPath = () => {
  const configDir = path__default.default.join(getXdgConfigHome(), "opencode");
  const jsoncPath = path__default.default.join(configDir, "opencode.jsonc");
  const jsonPath = path__default.default.join(configDir, "opencode.json");
  if (fs__default.default.existsSync(jsoncPath)) return jsoncPath;
  if (fs__default.default.existsSync(jsonPath)) return jsonPath;
  return jsoncPath;
};
var getClients = () => {
  const homeDir = os__default.default.homedir();
